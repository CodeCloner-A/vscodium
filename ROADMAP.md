...
Abgeleitet aus der Feature-Chronologie von Cursor (Changelog 2023–2025), gemappt auf den Ist-Zustand dieses Forks (Stand: 13. Juli 2026, Extension v0.10.0, Basis VS Code 1.121.0). Cursor-Referenzen in Klammern zeigen, wann Cursor das jeweilige Feature gebaut hat — als Beleg für die Reihenfolge, nicht als Kopiervorlage.
...
| **S** | **SaaS-Fundament (Auth, Proxy, Abrechnung)** | 6–8 Wochen | in Arbeit — 7/11 erledigt (Modell-Katalog v0.5.0, Proxy v1, Auth-Login v0.6.0, Proxy-Verkehr v0.7.0, Metering & Quoten v0.8.0, BYOK-Rückbau + Auth-Relay v0.9.0, Chat-Sync v0.10.0) |
