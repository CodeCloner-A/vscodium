...
| **S** | **SaaS-Fundament (Auth, Proxy, Abrechnung)** | 6–8 Wochen | in Arbeit — 6/11 erledigt (Modell-Katalog v0.5.0, Proxy v1, Auth-Login v0.6.0, Proxy-Verkehr v0.7.0, Metering & Quoten v0.8.0, BYOK-Rückbau + Auth-Relay v0.9.0) |
